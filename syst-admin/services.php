	...
	<div class="row">
		...
		<div class="col col-3">
			<div class="card mt-4">
				...
				<div class="card-body">
					<a href="create-service.php" class="btn btn-success btn-block mx-1 my-1" role="button">New Service</a>
					<a href="service-history.php" class="btn btn-info btn-block mx-1 my-1" role="button">Service History</a>
					<a href="service-items.php" class="btn btn-info btn-block mx-1 my-1" role="button">View Labor Items</a>
					<a href="part-items.php" class="btn btn-info btn-block mx-1 my-1" role="button">View Part Items</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col col-9">
			<div class="card mt-2">
				...
				<?php
					...
					$query = "SELECT s.*, u.fname, u.lname FROM services as s, users as u WHERE s.status = 6 AND u.userid = s.customer ORDER BY s.serviceid DESC";
					$run = mysqli_query($conn, $query);
